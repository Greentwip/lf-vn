...
namespace SNovel
{
	...
	*/
	...
	public:
		...
		void excute() override
		{
			...
			TextBoxesManager::getInstance()->showBackground();
	...
	*
	*/
	class CnTag : public  AbstractTag
	{
	public:
		CnTag()
		{
		...
		void excute() override
		{
			TextBoxesManager::getInstance()->clearName();
			TextBoxesManager::getInstance()->hideBackground();

			AbstractTag::excute();
		}
	};
	extern TagRegitser<CnTag> _cnTag;
