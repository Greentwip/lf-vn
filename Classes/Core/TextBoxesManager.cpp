...
namespace SNovel
{
	...
	*/
	...
	void TextBoxesManager::clearName()
	{
		CurrentNameTextBox->clearMessage();
		CurrentNameTextBox->setText("");
	}
	void TextBoxesManager::showBackground()
	{
		CurrentMainTextBox->showBackground();
	}
	void TextBoxesManager::hideBackground()
	{
		CurrentMainTextBox->hideBackground();
	}
